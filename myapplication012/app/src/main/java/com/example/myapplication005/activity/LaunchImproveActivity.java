...
import com.example.myapplication005.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.ysl,
            R.drawable.tf, R.drawable.dior, R.drawable.gucci, R.drawable.armani};
